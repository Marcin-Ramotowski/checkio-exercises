...
# 
# You have an uncompleted rectangular grid    and have to colour all the cells, either black or white,    with two constraints:No three consecutives cells, horizontally or vertically, are all black or all white.Each row and column contains as many black cells as white cells.Obviously, you can only change the empty cells, not the colored ones.
# 
