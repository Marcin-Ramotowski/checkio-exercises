...
# NOTE:
# 
# All loads can live together on the boat.Input:The number of wolves, goats, cabbages and payload (4 integers).
# 
# Output:The minimum number of the boat crossings (an integer).
# 
# Precondition:1 ≤ wolves + goats + cabbages ≤ 101 ≤ payload ≤ 5
# 
# 
# END_DESC
