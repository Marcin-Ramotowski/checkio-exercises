...
# Your task is to minimize the number of intervals by merging those that intersect or  by removing  those that are a part of other intervals.
...
# Taken from mission Merge Intervals
...
if __name__ == "__main__":
    ...
    assert list(merge_intervals([(1, 4), (2, 6), (8, 10), (12, 19)])) == [
        (1, 6),
        (8, 10),
        (12, 19),
    ], "First"
    assert list(merge_intervals([(1, 12), (2, 3), (4, 7)])) == [(1, 12)], "Second"
    assert list(merge_intervals([(1, 5), (6, 10), (10, 15), (17, 20)])) == [
        (1, 15),
        (17, 20),
    ], "Third"
